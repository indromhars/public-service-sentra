<div class="relative px-4 pt-5 pb-4 text-left sm:w-full sm:max-w-lg sm:p-6">
    <div class="sm:flex sm:items-start">
        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
            <div>
                <img src='<?php echo e((!empty($aspirasi->attachment)) ? Storage::url("attachments/$aspirasi->attachment") : ''); ?>' alt="" class="w-full rounded-md">
            </div>
        </div>
    </div>
...
<?php /**PATH /var/www/html/resources/views/livewire/view-attachment.blade.php ENDPATH**/ ?>