            ...
            <div class="flex flex-col items-center mt-10 w-full bg-white rounded-md">
                ...
                <div class="flex flex-row w-full mt-4 justify-between">
                    ...
                    <div>
                        ...
                        <button wire:click="attachment(<?php echo e($a->id); ?>)" class="flex w-20 h-10 mt-4 ml-2 mr-6 mb-4 bg-yellow-400 text-white font-semibold rounded-md justify-center items-center">Lampiran</button>
                    </div>
                    <div>
                        <?php if($a->status == 0): ?>
                            ...
                            <div>
                                ...
                                <div class="flex py-2 mr-2">
                                    <?php for($star = 1; $star < 6; $star++): ?>
                                        ...
                                        <?php else: ?>
                                            <svg wire:click="rate(<?php echo e($a->id); ?>, <?php echo e($star); ?>)" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 cursor-pointer">
...
<?php /**PATH /var/www/html/resources/views/livewire/guest-history-aspirasi.blade.php ENDPATH**/ ?>